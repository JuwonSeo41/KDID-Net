...
class MetricCounter:
    ...
    def add_losses(self, l_G, l_content, l_adv, l_cla=0, l_D=0):
        for name, value in zip(('G_loss', 'G_loss_content', 'G_loss_adv', 'loss_cla', 'D_loss'),
                               (l_G, l_content, l_adv, l_cla, l_D)):
    ...
    def write_to_tensorboard(self, epoch_num, validation=False):
        ...
        for tag in ('G_loss', 'D_loss', 'G_loss_adv', 'G_loss_content', 'loss_cla', 'SSIM', 'PSNR'):
