...
class Trainer:
    def __init__(self, config, train: DataLoader, val: DataLoader):
        ...
        self.metric_counter = MetricCounter(self.save_dir)
    ...
    def _run_epoch(self, epoch):
        ...
        for data in tq:
            ...
            KD_feature_loss = 0.05 * KD_feature_loss_first + 0.1 * KD_feature_loss_middle + KD_feature_loss_last # 0.05 0.1
...
def main(config_path='config/KD_config0.050.1_2nd.yaml'):
